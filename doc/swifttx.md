...
This mechanism has been integrated into Bitcore-Node-SIQS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SIQS-Developer/insight-api-SIQS#web-socket-api](https://github.com/SIQS-Developer/insight-api-SIQS#web-socket-api)
* API: [https://github.com/SIQS-Developer/insight-api-SIQS#swifttx-transactions](https://github.com/SIQS-Developer/insight-api-SIQS#swifttx-transactions)
...
By default, the SIQS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SIQS Core daemon:
