...
In order to support loading of multiple wallets in SIQS-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is SIQS.cpp.
...
Changes to SIQS.cpp
----------------------
SIQS.cpp is the entry point into SIQS-qt, and as such, will require some minor modifications to provide hooks for
