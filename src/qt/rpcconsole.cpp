                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSIQSPathCustom = GetArg("-zSIQSbackuppath", "");
    ...
    if(!strzSIQSPathCustom.empty()) {
        ui->wallet_customzSIQSbackuppath->setText(QString::fromStdString(strzSIQSPathCustom));
        ui->wallet_customzSIQSbackuppath_label->setVisible(true);
        ui->wallet_customzSIQSbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSIQSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SIQS RPC console.") + "<br>" +
