...
/* SIQS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SIQS"
#define QAPP_ORG_DOMAIN "SIQS.me"
#define QAPP_APP_NAME_DEFAULT "SIQS-Qt"
#define QAPP_APP_NAME_TESTNET "SIQS-Qt-testnet"
