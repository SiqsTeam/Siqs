...
bool CheckProofOfStake(const CBlock block, uint256& hashProofOfStake, std::unique_ptr<CStakeInput>& stake)
{
    ...
    if (tx.IsZerocoinSpend()) {
        ...
        stake = std::unique_ptr<CStakeInput>(new CZSIQSStake(spend));
    } else {
        ...
        CSIQSStake* SIQSInput = new CSIQSStake();
        SIQSInput->SetInput(txPrev, txin.prevout.n);
        stake = std::unique_ptr<CStakeInput>(SIQSInput);
    }
