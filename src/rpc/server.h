...
extern UniValue setzSIQSseed(const UniValue& params, bool fHelp);
extern UniValue getzSIQSseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzSIQS(const UniValue& params, bool fHelp);
extern UniValue dzSIQSstate(const UniValue& params, bool fHelp);
