...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in SIQS\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zSIQSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSIQS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSIQS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSIQS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSIQS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSIQS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSIQS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSIQS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSIQS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSIQS denominations\n"
            "  }\n"
            "}\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of SIQS addresses\n"
            "     \"SIQSaddress\"   	 	(string) SIQS address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
