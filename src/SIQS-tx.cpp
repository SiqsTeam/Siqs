...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SIQS Core SIQS-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  SIQS-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SIQS transaction") + "\n" +
                               "  SIQS-tx [options] -create [commands]   " + _("Create hex-encoded SIQS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded SIQS transaction
