...
RESOURCES += src/qt/SIQS.qrc src/qt/SIQS_locale.qrc

TRANSLATIONS += src/qt/locale/SIQS_bg.ts \
                src/qt/locale/SIQS_de.ts \
                src/qt/locale/SIQS_en.ts \
                src/qt/locale/SIQS_es.ts \
                src/qt/locale/SIQS_fi.ts \
                src/qt/locale/SIQS_fr.ts \
                src/qt/locale/SIQS_it.ts \
                src/qt/locale/SIQS_ja.ts \
                src/qt/locale/SIQS_pl.ts \
                src/qt/locale/SIQS_pt.ts \
                src/qt/locale/SIQS_ru.ts \
                src/qt/locale/SIQS_sk.ts \
                src/qt/locale/SIQS_sv.ts \
                src/qt/locale/SIQS_vi.ts \
                src/qt/locale/SIQS_zh_CN.ts \
                src/qt/locale/SIQS_zh_TW.ts
