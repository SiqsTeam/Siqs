Contributing to SIQS Core
============================

The SIQS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SIQS Core project, and is not to be
confused with overall SIQS Network Protocol consensus changes.

Whether a pull request is merged into SIQS Core rests with the project merge
...
Patches that change SIQS consensus rules are considerably more involved than
...
Where a patch set proposes to change the SIQS consensus, it must have been
...
The project leader is the release manager for each SIQS Core release.
