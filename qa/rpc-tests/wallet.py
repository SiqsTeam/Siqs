...
#   c) node1 mines 32 blocks, so now node 0 has 60001SIQS, node 1 has 4250SIQS, node2 has none.
#   d) node0 sends 601 SIQS to node2, in two transactions (301 SIQS, then 300 SIQS).
